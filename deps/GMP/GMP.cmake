...
if (MSVC)
    ...
    if (APPLE)
        if (${CMAKE_OSX_ARCHITECTURES} MATCHES "arm")
            ...
            set(_gmp_build_arch_flags "-arch arm64")
        elseif (${CMAKE_OSX_ARCHITECTURES} MATCHES "x86_64")
            set(_gmp_build_tgt x86_64)
            set(_gmp_build_arch_flags "-arch x86_64")
        endif()
        set(_gmp_ccflags "${_gmp_ccflags} ${_gmp_build_arch_flags} -mmacosx-version-min=${DEP_OSX_TARGET}")
